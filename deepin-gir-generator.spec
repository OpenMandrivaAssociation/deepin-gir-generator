...
# go mod download
# tar cJf ../../godeps-for-go-gir-3.0.4.tar.xz .godeps
Source1:	godeps-for-go-gir-3.0.4.tar.xz
...
install -m 0644 gio-2.0/gio.gen.c %{buildroot}%{_datadir}/gocode/src/%{import_path}/gio-2.0
install -m 0644 glib-2.0/glib.gen.c %{buildroot}%{_datadir}/gocode/src/%{import_path}/glib-2.0
install -m 0644 gobject-2.0/fix_gobject.c %{buildroot}%{_datadir}/gocode/src/%{import_path}/gobject-2.0
install -m 0644 gobject-2.0/gobject.gen.c %{buildroot}%{_datadir}/gocode/src/%{import_path}/gobject-2.0
install -m 0644 gudev-1.0/gudev.gen.c %{buildroot}%{_datadir}/gocode/src/%{import_path}/gudev-1.0

mkdir -p %{buildroot}%{_bindir}
install -m 0755 generator/generator %{buildroot}%{_bindir}/gir-generator
install -m 0755 test/test %{buildroot}%{_bindir}/gir-test
%fdupes %{buildroot}
